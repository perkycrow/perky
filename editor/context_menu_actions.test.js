...
describe('context_menu_actions', () => {

    describe('getActionsForModule', () => {

        describe('default actions', () => {

            it('should include Focus action', () => {
            ...
            it('should call onFocus callback when Focus action is executed', () => {
                const module = new PerkyModule({$id: 'test'})
                const onFocus = vi.fn()
            ...
            it('should include Stop action when module is started', () => {
                const module = new PerkyModule({$id: 'test'})
                module.start()
                const actions = getActionsForModule(module, {})
            ...
            it('should include Start action when module is stopped', () => {
                const module = new PerkyModule({$id: 'test'})
                const actions = getActionsForModule(module, {})
            ...
            it('should disable Start/Stop for static modules', () => {
            ...
            it('should include Dispose action', () => {
                const module = new PerkyModule({$id: 'test'})
                const actions = getActionsForModule(module, {})
            ...
            it('should disable Dispose for already disposed modules', () => {
                const module = new PerkyModule({$id: 'test'})
                module.dispose()
                const actions = getActionsForModule(module, {})
            ...
            it('should call module.stop() when Stop action is executed', () => {
                const module = new PerkyModule({$id: 'test'})
                module.start()
            ...
            it('should call module.start() when Start action is executed', () => {
                const module = new PerkyModule({$id: 'test'})
            ...
            it('should call module.dispose() when Dispose action is executed', () => {
                const module = new PerkyModule({$id: 'test'})
        ...
        describe('GameLoop actions', () => {

            it('should include Pause action for running GameLoop', () => {
            ...
            it('should include Resume action for paused GameLoop', () => {
                const gameLoop = new GameLoop()
                gameLoop.start()
                gameLoop.pause()
                const actions = getActionsForModule(gameLoop, {})
            ...
            it('should disable Pause/Resume when GameLoop is not started', () => {
                const gameLoop = new GameLoop()
                const actions = getActionsForModule(gameLoop, {})
            ...
            it('should call gameLoop.pause() when Pause action is executed', () => {
                const gameLoop = new GameLoop()
                gameLoop.start()
            ...
            it('should call gameLoop.resume() when Resume action is executed', () => {
                const gameLoop = new GameLoop()
                gameLoop.start()
                gameLoop.pause()
