...
const SCENARIOS = [
...

    {
        ...
        factions: [
            {name: 'shadow', x: -2, y: 0, units: line('Rat', 3, -0.5, 0.5, {spores: ['anger', 'naive']})},
            {name: 'light', x: 2, y: 0, units: line('Rat', 3, -0.5, 0.5, {spores: ['fear', 'sadness']})}
        ]
    },
...

    {
        ...
        factions: [
            {name: 'shadow', x: -2, y: 0, units: [
                u('Shade', {spores: ['lust']}),
                u('Rat', {y: 0.5, spores: ['lust']}),
                u('Rat', {y: -0.5, spores: ['lust']})
            ]},
            {name: 'light', x: 2, y: 0, units: [
...

    {
        ...
        factions: [
            ...
            {name: 'light', x: 2, y: 0, units: line('Rat', 4, -0.8, 0.5)}
        ]
    },
...

    {
        ...
        factions: [
            {name: 'shadow', x: -2.5, y: 0, units: line('Skeleton', 4, -0.8, 0.5, {spores: ['sadness']})},
            {name: 'light', x: 2.5, y: 0, units: line('Rat', 6, -1.2, 0.5, {spores: ['anger']})}
        ]
    },
...

    {
        ...
        factions: [
            ...
            {name: 'light', x: 2, y: 0, units: line('Shade', 3, -0.5, 0.5)}
        ]
    }
]
