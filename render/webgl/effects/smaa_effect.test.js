...
function createMockGL () {
    ...
    return {
        ...
        calls,
        createTexture () { return 'smaaTex' },
        createFramebuffer () { return 'smaaFBO' },
...
function createMockShaderRegistry () {
    const mockProgram = {
        program: 'smaaProgram',
        uniforms: {
            uColorTexture: 0, uTexelSize: 1,
            uEdgesTexture: 2, uAreaTexture: 3, uSearchTexture: 4,
            uViewportSize: 5, uBlendTexture: 6
        },
