...
function createMockGL () {
    ...
    return {
        ...
        calls,
        createTexture () { return 'ssaoTex' },
        createFramebuffer () { return 'ssaoFBO' },
...
function createMockShaderRegistry () {
    const mockProgram = {
        program: 'ssaoProgram',
        uniforms: {
            uDepth: 0, uGNormal: 1, uProjection: 2,
            uInverseViewProjection: 3, uView: 4, uTexelSize: 5,
            uRadius: 6, uBias: 7, uIntensity: 8,
            uSSAOTexture: 9
        },
